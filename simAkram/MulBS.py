...
class myNode():
    def __init__(self, id,bases, period, packetlen):
        global bs
...
def transmit(env,node):
    while True:
		...
		print "Je suis dans le dernier else"
...
if i == 0:
    ...
    nrBS = input("Nombre de staions de base  : ")
    ...
    nrBS = input("Nombre de stations de base  : ")
...
for i in range(0,nrNodes):
    ...
    node = myNode(i,avgSendTime, avgSendTime,size)
    nodes.append(node)
